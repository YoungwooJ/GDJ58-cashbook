          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>세부 내역</strong></h1>
					<!-- 
					<div class="row">
											...
											<table class="table table-border">
												...
												%>
															<tr>
																...
																<td><a class="badge bg-warning" href="<%=request.getContextPath()%>/cash/updateCashForm.jsp?cashNo=<%=(Integer)m.get("cashNo")%>&year=<%=year%>&month=<%=month%>&date=<%=date%>">수정</a></td>
																<td><a class="badge bg-danger" href="<%=request.getContextPath()%>/cash/deleteCashForm.jsp?cashNo=<%=(Integer)m.get("cashNo")%>&categoryKind=<%=(String)m.get("categoryKind")%>&categoryName=<%=(String)m.get("categoryName")%>&year=<%=year%>&month=<%=month%>&date=<%=date%>">삭제</a></td>
															</tr>
												<%			
														}		
													}
