          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>고객센터</strong></h1>
					<!-- 
					<div class="row">
									...
									<div class="align-self-center w-100">
										<div class="chart">
											...
											<div>
														...
														<tr>
															...
															<td>
																<%
																	if(m.get("commentMemo") == null){
																%>
																		<a class="badge bg-warning" href="<%=request.getContextPath()%>/help/updateHelpForm.jsp?helpNo=<%=helpNo%>">수정</a>	
																<%		
																	} else {
																%>
																		&nbsp;
															...
															<td>
																<%
																	if(m.get("commentMemo") == null){
																%>
																		<a class="badge bg-danger" href="<%=request.getContextPath()%>/help/deleteHelpAction.jsp?helpNo=<%=helpNo%>">삭제</a>	
																<%		
																	} else {
																%>
																		&nbsp;
												...
												<a class="btn btn-primary" href="<%=request.getContextPath()%>/cash/cashList.jsp">홈으로</a>
												<a style="float:right;" class="btn btn-info" href="<%=request.getContextPath()%>/help/insertHelpForm.jsp">추가</a>
											</div>
										</div>
									</div>
								</div>
