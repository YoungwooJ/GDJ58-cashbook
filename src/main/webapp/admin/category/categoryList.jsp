								...
								<div class="card-body d-flex">
									<div class="align-self-center w-100">
										<div class="chart">
												...
												<%
													...
													%>
														<tr>
															...
															<td>
																<a class="badge bg-warning" href="<%=request.getContextPath()%>/admin/category/updateCategoryForm.jsp?categoryNo=<%=c.getCategoryNo()%>">수정</a>
															</td>
															<td>
																<a class="badge bg-danger" href="<%=request.getContextPath()%>/admin/category/deleteCategoryAction.jsp?categoryNo=<%=c.getCategoryNo()%>">삭제</a>
															</td>
														</tr>
													<%	
													}
											...
											<a class="btn btn-primary" href="<%=request.getContextPath()%>/admin/adminMain.jsp">이전</a>
											<a style="float:right;" class="btn btn-info" href="<%=request.getContextPath()%>/admin/category/insertCategoryForm.jsp">카테고리 추가</a>
										</div>
									</div>
								</div>
							</div>
