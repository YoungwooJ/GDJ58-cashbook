						...
						<div class="col-12 col-lg-8 col-xxl-9 d-flex order-3 order-xxl-2">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">멤버 목록</h5>
								</div>
									...
									<div class="align-self-center w-100">
										<div class="chart">
												...
												<%
													...
													%>
														<tr>
															...
															<td><a class="badge bg-warning" href="<%=request.getContextPath()%>/admin/member/updateMemberForm.jsp?memberNo=<%=m.getMemberNo()%>">수정</a></td>
															<td><a class="badge bg-danger" href="<%=request.getContextPath()%>/admin/member/deleteMemberForm.jsp?memberNo=<%=m.getMemberNo()%>">삭제</a></td>
														</tr>
													<%				
													}
												%>
											...
											<div class="btn-group btn-group-sm mb-4" role="group" aria-label="Small button group">
												<a type="button" class="btn btn-outline-primary" href="<%=request.getContextPath()%>/admin/member/memberList.jsp?currentPage=1" style="text-decoration: none;">처음</a>
													<%
														if(currentPage > 1) {
													%>
															<a type="button" class="btn btn-outline-primary" href="<%=request.getContextPath()%>/admin/member/memberList.jsp?currentPage=<%=currentPage-1%>" style="text-decoration: none;">이전</a>
													<%
														}
													%>
													...
													%>
															<a type="button" class="btn btn-outline-primary" href="<%=request.getContextPath()%>/admin/member/memberList.jsp?currentPage=<%=currentPage+1%>" style="text-decoration: none;">다음</a>
													<%		
														}
													%>
												<a type="button" class="btn btn-outline-primary" href="<%=request.getContextPath()%>/admin/member/memberList.jsp?currentPage=<%=lastPage%>" style="text-decoration: none;">마지막</a>
											</div>
											<br>
