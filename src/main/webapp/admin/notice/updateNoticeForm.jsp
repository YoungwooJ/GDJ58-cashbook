										...
										<div class="chart">
											...
											<table class="table table-border">
												...
												<tr>
													<th>공지 내용</th>
													<td>
														<textarea rows="5" cols="50" name="noticeMemo"><%=notice.getNoticeMemo()%></textarea>
													</td>
												</tr>
											</table>
											<a style="float:left;" class="btn btn-primary" href="<%=request.getContextPath()%>/admin/notice/noticeList.jsp?currentPage=<%=currentPage%>">이전</a>
